'''
CUDA_VISBILE_DEIVCES=0,1,2,3,4,5,6,7 bash tools/dist_train.sh configs_pretrain/Swin_B_pretrain.py 8
python tools/train.py configs_pretrain/Swin_B_pretrain.py
'''
...
backbone_checkpoint = '/mnt/public/usr/wangmingze/pretrain/swin_B_window12_imagenet22k_pre384_mmseg.pth'
