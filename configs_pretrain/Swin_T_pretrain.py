'''
CUDA_VISBILE_DEIVCES=0,1,2,3,4,5,6,7 bash tools/dist_train.sh configs_pretrain/Swin_T_pretrain.py 4
python tools/train.py configs_pretrain/Swin_T_pretrain.py
'''
...
backbone_checkpoint = '/mnt/public/usr/wangmingze/pretrain/swin_T_mmseg.pth'
