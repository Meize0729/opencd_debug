'''
CUDA_VISBILE_DEIVCES=0,1,2,3,4,5,6,7 bash tools/dist_train.sh configs_pretrain/ViT_L_pretrain.py 8
python tools/train.py configs_pretrain/ViT_L_pretrain.py
'''
...
backbone_checkpoint = 'pretrain/sam_vit_l_mm_allin.pth'
