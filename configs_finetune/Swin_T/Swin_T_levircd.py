'''
python tools/train.py configs_finetune_new/Swin_T/Swin_T_levircd.py
'''
...
train_data_list = '/mnt/public/usr/wangmingze/opencd/data_list/levircd/data_list_levircd_train.txt'
