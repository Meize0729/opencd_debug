...
if __name__ == '__main__':
    # 文件夹路径
    folder_path = '/mnt/public/usr/wangmingze/Datasets/CD/openai_challenge/label'
    real_folder_path = os.path.dirname(folder_path)
    out_path = folder_path.replace(real_folder_path, 'label_png')
